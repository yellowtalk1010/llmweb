...
//        String tradeDateCopy = tradeDate;
//        if(tradeDateCopy==null || StringUtils.isEmpty(tradeDateCopy)){
//            tradeDateCopy = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
//        }
//
//        String key = period + "_" + type + "_" + tradeDateCopy;
//        if (JJQC_RESPONSE_MAP.get(key)!=null) {
//            return JJQC_RESPONSE_MAP.get(key);
//        }
//        String url = "https://stockapi.com.cn/v1/base/jjqc?period=" + period + "&type=" + type + "&tradeDate=" + tradeDateCopy + "&token=" + LoaderLocalStockData.TOKEN();
