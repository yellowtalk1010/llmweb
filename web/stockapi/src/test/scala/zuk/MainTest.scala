...
class MainTest extends AnyFunSuite {
  ...
  test("main推荐测试"){
    val args = Array("-engine_path", "D:\\development\\github\\tushare\\111\\gitee_stockapi\\", "-json")
    zuk.Main.main(args)
  }

  test("main回测测试") {
//    PassFactory.models = List(new MA7_Model)
    val args = Array("-engine_path", "D:\\development\\github\\tushare\\111\\gitee_stockapi\\", "-json", "-back")
    zuk.Main.main(args)
  }
