...
//        String conversationId = getConversationId(chatClientRequest.context(), this.defaultConversationId);//为了解决编译
...
//        this.chatMemory.add(this.getConversationId(chatClientResponse.context(), this.defaultConversationId), assistantMessages); ////为了解决编译
...
//        private String conversationId = ChatMemory.DEFAULT_CONVERSATION_ID;
        ...
        private String conversationId = ""; //未了解决编译
