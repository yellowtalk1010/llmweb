package zuk.sast;// Generated from java-escape by ANTLR 4.11.1
...
public class CParser extends Parser {
	...
	public static final int
		...
		RULE_externalDeclaration = 84, RULE_functionDefinition = 85, RULE_functionDefinitonSuffix = 86,
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"translationUnit", "externalDeclaration", "functionDefinition", "functionDefinitonSuffix",
			"declarationList"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'_at_'", "'__m128'", "'__m128d'", "'__m128i'", "'__typeof__'", "'__inline__'",
	...
	public final DeclarationContext declaration() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 128000L) != 0 || (((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 70368752631809L) != 0) {
					{
					setState(417);
					initDeclaratorList();
					}
	...
	public final DeclarationSpecifiers2Context declarationSpecifiers2() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 5674214351274512354L) != 0 || _la==ThreadLocal || _la==Identifier );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final StructDeclarationListContext structDeclarationList() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & -8197507060972125726L) != 0 || _la==Identifier );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private DirectAbstractDeclaratorContext directAbstractDeclarator(int _p) throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 5674214351274512354L) != 0 || _la==ThreadLocal || _la==Identifier) {
					{
					setState(808);
					parameterTypeList();
					}
	...
	public final CompoundStatementContext compoundStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & -2305843010288611346L) != 0 || (((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 2111062968360995L) != 0) {
				{
				setState(975);
				blockItemList();
				}
	...
	public final BlockItemListContext blockItemList() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & -2305843010288611346L) != 0 || (((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 2111062968360995L) != 0 );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & -3549157685580136478L) != 0 || (((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 140738042134531L) != 0) {
				{
				setState(1073);
				translationUnit();
				}
	...
	public final TranslationUnitContext translationUnit() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & -3549157685580136478L) != 0 || (((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 140738042134531L) != 0 );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class FunctionDefinitionContext extends ParserRuleContext {
		...
		public FunctionDefinitonSuffixContext functionDefinitonSuffix() {
			return getRuleContext(FunctionDefinitonSuffixContext.class,0);
		}
		public CompoundStatementContext compoundStatement() {
			return getRuleContext(CompoundStatementContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class FunctionDefinitonSuffixContext extends ParserRuleContext {
		public List<TerminalNode> Identifier() { return getTokens(CParser.Identifier); }
		public TerminalNode Identifier(int i) {
			return getToken(CParser.Identifier, i);
		}
		...
		public FunctionDefinitonSuffixContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_functionDefinitonSuffix; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CListener ) ((CListener)listener).enterFunctionDefinitonSuffix(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CListener ) ((CListener)listener).exitFunctionDefinitonSuffix(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CVisitor ) return ((CVisitor<? extends T>)visitor).visitFunctionDefinitonSuffix(this);
			else return visitor.visitChildren(this);
		}
	}

	public final FunctionDefinitonSuffixContext functionDefinitonSuffix() throws RecognitionException {
		FunctionDefinitonSuffixContext _localctx = new FunctionDefinitonSuffixContext(_ctx, getState());
		enterRule(_localctx, 172, RULE_functionDefinitonSuffix);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==Identifier || _la==Constant) {
				{
				{
				setState(1098);
				_la = _input.LA(1);
	...
	public static final String _serializedATN =
		...
		"\b5\u00016\u00016\u00036\u02cb\b6\u00046\u02cd\b6\u000b6\f6\u02ce\u0001"+
		"7\u00047\u02d2\b7\u000b7\f7\u02d3\u00018\u00018\u00018\u00038\u02d9\b"+
		"8\u00019\u00019\u00019\u00059\u02de\b9\n9\f9\u02e1\t9\u0001:\u0001:\u0001"+
		":\u0001:\u0001:\u0003:\u02e8\b:\u0003:\u02ea\b:\u0001;\u0001;\u0001;\u0005"+
		";\u02ef\b;\n;\f;\u02f2\t;\u0001<\u0001<\u0003<\u02f6\b<\u0001=\u0001="+
		"\u0003=\u02fa\b=\u0001=\u0001=\u0005=\u02fe\b=\n=\f=\u0301\t=\u0003=\u0303"+
		...
		"E\u0001E\u0004E\u0392\bE\u000bE\fE\u0393\u0001E\u0001E\u0001E\u0001F\u0001"+
		"F\u0001F\u0001F\u0001F\u0001F\u0001F\u0001F\u0001F\u0001F\u0001F\u0001"+
		"F\u0005F\u03a5\bF\nF\fF\u03a8\tF\u0003F\u03aa\bF\u0001F\u0001F\u0001F"+
		"\u0001F\u0005F\u03b0\bF\nF\fF\u03b3\tF\u0003F\u03b5\bF\u0005F\u03b7\b"+
		"F\nF\fF\u03ba\tF\u0001F\u0001F\u0003F\u03be\bF\u0001G\u0001G\u0001G\u0003"+
		"G\u03c3\bG\u0001G\u0001G\u0001G\u0001G\u0001G\u0001G\u0001G\u0001G\u0003"+
		"G\u03cd\bG\u0001H\u0001H\u0003H\u03d1\bH\u0001H\u0001H\u0001I\u0004I\u03d6"+
		"\bI\u000bI\fI\u03d7\u0001J\u0001J\u0003J\u03dc\bJ\u0001K\u0003K\u03df"+
		"\bK\u0001K\u0001K\u0001L\u0001L\u0001L\u0001L\u0001L\u0001L\u0001L\u0003"+
		"L\u03ea\bL\u0001L\u0001L\u0001L\u0001L\u0001L\u0001L\u0003L\u03f2\bL\u0001"+
		"M\u0001M\u0001M\u0001M\u0001M\u0001M\u0001M\u0001M\u0001M\u0001M\u0001"+
		"M\u0001M\u0001M\u0001M\u0001M\u0001M\u0001M\u0001M\u0001M\u0001M\u0003"+
		"M\u0408\bM\u0001N\u0001N\u0003N\u040c\bN\u0003N\u040e\bN\u0001N\u0001"+
		"N\u0003N\u0412\bN\u0001N\u0001N\u0003N\u0416\bN\u0001O\u0001O\u0003O\u041a"+
		"\bO\u0001P\u0001P\u0001P\u0005P\u041f\bP\nP\fP\u0422\tP\u0001Q\u0001Q"+
		"\u0001Q\u0001Q\u0001Q\u0001Q\u0003Q\u042a\bQ\u0001Q\u0001Q\u0003Q\u042e"+
		"\bQ\u0001Q\u0001Q\u0001R\u0003R\u0433\bR\u0001R\u0001R\u0001S\u0004S\u0438"+
		"\bS\u000bS\fS\u0439\u0001T\u0001T\u0001T\u0003T\u043f\bT\u0001U\u0003"+
		"U\u0442\bU\u0001U\u0001U\u0003U\u0446\bU\u0001U\u0001U\u0001U\u0001V\u0005"+
		"V\u044c\bV\nV\fV\u044f\tV\u0001W\u0004W\u0452\bW\u000bW\fW\u0453\u0001"+
		"W\u0000\u0002`|X\u0000\u0002\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014"+
		"\u0016\u0018\u001a\u001c\u001e \"$&(*,.02468:<>@BDFHJLNPRTVXZ\\^`bdfh"+
		"jlnprtvxz|~\u0080\u0082\u0084\u0086\u0088\u008a\u008c\u008e\u0090\u0092"+
		"\u0094\u0096\u0098\u009a\u009c\u009e\u00a0\u00a2\u00a4\u00a6\u00a8\u00aa"+
		"\u00ac\u00ae\u0000\u0015\u0001\u0000lm\u0003\u0000--NNPP\u0002\u0000-"+
		"-88\u0005\u0000MMOOQQTTYZ\u0001\u0000QS\u0002\u0000MMOO\u0001\u0000KL"+
		"\u0001\u0000GJ\u0001\u0000jk\u0001\u0000_i\u0002\u0000\u0004\u0004__\u0006"+
		"\u0000\u0015\u0015  ((..11@@\u0001\u0000\u0005\u0007\u0002\u0000//22\u0004"+
		"\u0000\u0019\u0019))5599\u0002\u0000\n\n\f\u0010\u0002\u0000AB^^\u0002"+
		"\u0000QQXX\u0002\u0000\u0011\u0011\u0013\u0013\u0002\u0000\u0014\u0014"+
