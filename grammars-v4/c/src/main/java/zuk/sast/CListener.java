...
public interface CListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CParser#functionDefinitonSuffix}.
	 * @param ctx the parse tree
	 */
	void enterFunctionDefinitonSuffix(CParser.FunctionDefinitonSuffixContext ctx);
	/**
	 * Exit a parse tree produced by {@link CParser#functionDefinitonSuffix}.
	 * @param ctx the parse tree
	 */
	void exitFunctionDefinitonSuffix(CParser.FunctionDefinitonSuffixContext ctx);
	/**
